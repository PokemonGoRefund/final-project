...
import { Button, Center, Container, Group, LoadingOverlay, Paper, PasswordInput, Stack, Text, TextInput, Title, UnstyledButton, } from '@mantine/core';
              ...
              Forgot password?
                            ...
                            <Center>
                                <Group mt={'md'}>
                                    ...
                                    <UnstyledButton onClick={handleSignUp}>
                                        <Text c={'red'}>
                                            Sign up
                                        </Text>
                                    </UnstyledButton>
                                    {/* <Link href={''} color='red'>Sign up</Link> */}
                                </Group>
                            </Center>
                        </Paper>
                    </form>
