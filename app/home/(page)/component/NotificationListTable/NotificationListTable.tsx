...
const NotificationListTable: FC = () => {
    ...
    const filteredProduct = dataNotification.filter((p) => {
        return (
                        ...
                        onChange={(event) =>
                            setSelectedRows(
                                event.currentTarget.checked
                                    ? [...selectedRows, row.order_id]
                                    : selectedRows.filter((position) => position !== row.order_id)
                            )
                        }
                    />
                </Table.Td>
